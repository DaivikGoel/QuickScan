    ...
    var state: State {
        ...
        set {
            ...
            case .notReady:
                ...
                if let camera = self.viewController.session.currentFrame?.camera {
...
//                flashlightButton.isHidden = true
                ...
                viewController.session.run(configuration, options: .resetTracking)
...
//                self.nextButton.setTitle("Finish", for: [])
                ...
                self.viewController.stopPlaneDetection()
